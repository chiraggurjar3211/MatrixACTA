...
public class PreviousAdjustmentSummaryReportPO extends AbstractMethod {
	WebDriver driver;

	public PreviousAdjustmentSummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void previousAdjustmentSummaryReport(String month1, String year1, String selectuser,
