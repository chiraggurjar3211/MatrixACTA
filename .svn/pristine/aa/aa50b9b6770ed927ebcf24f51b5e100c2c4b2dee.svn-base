...
public class VisitorHeadCountReportPO extends AbstractMethod {
	WebDriver driver;
	
	public VisitorHeadCountReportPO(WebDriver driver) {
	       super(driver);
	       this.driver = driver;
	...
	public void visitorHeadCountReport(String fDate , String tDate , String selectVisitors , String reportExportFormat) throws Exception {
		pageLoadWaitng();
