...
public class UserLateInReportPO extends AbstractMethod {
	WebDriver driver;
	
	public UserLateInReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 public void userLateInReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		 pageLoadWaitng();
