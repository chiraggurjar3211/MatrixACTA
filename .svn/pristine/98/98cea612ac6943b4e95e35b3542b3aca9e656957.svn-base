...
public class ItemWiseConsumptionReportPO extends AbstractMethod {
	
	WebDriver driver;
	
	public ItemWiseConsumptionReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void itemWiseConsumptionReport(String fDate , String tDate , String groupby , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
