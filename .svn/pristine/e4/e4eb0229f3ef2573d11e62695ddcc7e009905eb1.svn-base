...
public class GraceTimeUsageReportPO extends AbstractMethod {
	WebDriver driver;
	
	public GraceTimeUsageReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void graceTimeUsageReport(String fDate , String tDate , String selectuser, String reportExportFormat) throws Exception {
		pageLoadWaitng();
