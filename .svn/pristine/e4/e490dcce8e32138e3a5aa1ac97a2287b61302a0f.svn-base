...
public class DailyHeadCountReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DailyHeadCountReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void dailyHeadCountReport(String fDate , String tDate , String selectcontracter , String selectworkorder  , String reportExportFormat) throws Exception {
		pageLoadWaitng();
