...
public class AbsentReportPO extends AbstractMethod {
	WebDriver driver;
	
	public AbsentReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 public void absentReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		 pageLoadWaitng();
