...
public class AttendanceSummaryChartReportPO extends AbstractMethod {
	WebDriver driver;
	
	public AttendanceSummaryChartReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	@FindBy(id = "_calFromDate")
	 ...
	 public void attendenceSummaryChartReportPO(String fDate , String tDate , String reportExportFormat) throws Exception {
		 pageLoadWaitng();
