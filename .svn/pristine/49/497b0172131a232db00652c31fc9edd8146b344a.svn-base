...
public class DailyWorkHoursReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DailyWorkHoursReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void dailyWorkHoursReport(String fDate , String tDate , String selectcontracter , String selectworkorder  , String  selectworker , String reportExportFormat) throws Exception {
		pageLoadWaitng();
