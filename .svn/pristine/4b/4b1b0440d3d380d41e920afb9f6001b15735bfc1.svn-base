...
public class DailySummaryReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DailySummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void dailySummaryReport(String fDate , String tDate , String selectcontracter , String selectworkorder  , String  selectworker , String reportExportFormat) throws Exception {
		pageLoadWaitng();
