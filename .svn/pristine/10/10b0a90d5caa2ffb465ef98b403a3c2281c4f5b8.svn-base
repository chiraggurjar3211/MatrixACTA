...
public class HourlyAttendanceReportPO extends AbstractMethod {
	WebDriver driver;
	
	public HourlyAttendanceReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void hourlyAttendenceReport(String fDate , String  tDate, String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
