...
public class LateInReportPO extends AbstractMethod {
	WebDriver driver;
	
	public LateInReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void lateInReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
