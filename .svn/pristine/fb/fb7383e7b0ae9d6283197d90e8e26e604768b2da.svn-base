...
public class ExpiredPassReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ExpiredPassReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void expiredPassReport(String fDate , String tDate , String reportExportFormat) throws Exception {
		pageLoadWaitng();
