...
public class EssCOffApplicationApprovalPO extends AbstractMethod {
	WebDriver driver;
	private static Logger logger=LogManager.getLogger(EssCOffApplicationApprovalPO.class);
	
	public EssCOffApplicationApprovalPO(WebDriver driver) {
		super(driver);
	...
	@FindBy(id = "filtered")
	private WebElement cOffDateRadioBtn;
	...
	////////////////
	public void cOffApplicationApproval(String fromDtHeader, String toDtHeader, String user, String fromDate, String toDate, String approve, String reject,
		...
		element_InputTextUsingActionClass(searchBoxPendingCollaps, user);
		...
		for (int i = 0; i < pendingTableUserIdXpath.size(); i++) {
			...
			String getToDate = pendingTableUserIdXpath.get(i)
