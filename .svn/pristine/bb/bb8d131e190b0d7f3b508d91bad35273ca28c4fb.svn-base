...
public class EarlyOutRegisterReportPO extends AbstractMethod {
	WebDriver driver;
	
	public EarlyOutRegisterReportPO(WebDriver driver) {
	      super(driver);
	      this.driver = driver;
	...
	public void earlyOutRegisterReport(String month1 , String year1 , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
