...
public class ShiftScheduleAttendenceReportPO extends AbstractMethod{
	WebDriver driver;
	
	public ShiftScheduleAttendenceReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void shiftScheduleAttendenceReport(String month1 , String year1, String selectcontracter , String selectworkorder, String selectworker , String reportExportFormat) throws Exception {
		pageLoadWaitng();
