...
public class ElevatorAccessReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ElevatorAccessReportPO(WebDriver driver) {
	      super(driver);
	      this.driver = driver;
	...
	@FindBy(id = "cboElevator")
	private WebElement selectElevator;
	
	public void elevatorAccessReport(String fDate , String tDate , String selectelevator , String reportExportFormat) throws Exception {
		pageLoadWaitng();
		...
		Thread.sleep(1000);
		element_DropDownSelectByvisibleText(selectElevator, selectelevator);
		Thread.sleep(1000);
