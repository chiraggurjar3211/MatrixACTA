...
public class WorkOrderManDaysReportPO extends AbstractMethod {
	WebDriver driver;
	
	public WorkOrderManDaysReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void workOrderManDaysReport(String fDate , String tDate , String selectcontracter , String selectworkorder  , String reportExportFormat) throws Exception {
		pageLoadWaitng();
