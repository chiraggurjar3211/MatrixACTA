...
public class ScheduleStatusSummaryReportPO extends AbstractMethod {
	
	WebDriver driver;
	
	public ScheduleStatusSummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void scheduleStatusSummaryReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
