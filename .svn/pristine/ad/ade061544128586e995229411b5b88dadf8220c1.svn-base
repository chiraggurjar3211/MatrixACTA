...
public class AttendanceSummaryReportPO extends AbstractMethod {
	WebDriver driver;
	private static Logger logger=LogManager.getLogger(AttendanceSummaryReportPO.class);
	
	public AttendanceSummaryReportPO(WebDriver driver) {
	      super(driver);
	      this.driver = driver;
	...
	public void attendenceSummaryReport(String fDate , String tDate , String format1 , String showlessdetials, String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
		...
		if(format1.equalsIgnoreCase("Format 1")) {
			...
			else if(showlessdetials.equalsIgnoreCase("True")) {
                  if(!showlessDetials.isSelected()) {
