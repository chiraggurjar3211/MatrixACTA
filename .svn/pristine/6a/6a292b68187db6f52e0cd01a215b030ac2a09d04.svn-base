...
Feature: Network Hours Policy
  ...
  Scenario: Network Hrs Policy - Work Hours Within Shift - MinDurReq - Case5
    ...
    And Delete Overtime Policy from TnA module
      | Name            |
      | NetWrkHrsPlcChk |
    And Delete "99" shift schedule
    And Delete "99" shift
    And Create shift in Shift Configuration
      | ShiftID | StartTime | EndTime | HalfDay | FullDay | BreakStart | BreakEnd | DeductTypeFor2+PunchFlag | DeductTypeFor2+PunchValue | Validation         |
      |      99 | 09:00     | 22:00   | 06:00   | 12:00   | 13:00      | 14:00    | True                     | Actual Break Duration     | Saved Successfully |
    And Create Shift Schedule "99" with Start Date "01/01/2010"
      | ShiftID | RepeatShiftDays |
      |      99 |               7 |
    And Configure Off Day Configuration in Shift Schedule "99"
      | OffDay1 |
      | None    |
    And Create NetWork Hours Policy "NetWrkHrsPlcChk"
      | WorkComponent           | RangeFrom | RangeTo | ConsiderAs | MinDurReq | Factor | ApplicableDays |
    ...
    And Create user from user configuration
      | userid          | Active | AtdEnable | ACSEnable | ESSEnable | ESSDetail | PunchMarkingviaESS | MaxPunchesToBeConsidered | OvertimePlc     | ShiftSchedule | Validation         |
      | NetWrkHrsPlcChk | True   | True      | True      | True      | True      | True               |                        4 | NetWrkHrsPlcChk |            99 | Saved Successfully |
      | NetWrkHrsPlcChN | True   | True      | True      | True      | True      | True               | N-Punch                  | NetWrkHrsPlcChk |            99 | Saved Successfully |
    And Run Shift Process for Month = "January" and Year = "2024"
      | UserID          |
      | NetWrkHrsPlcChk |
      | NetWrkHrsPlcChN |
  ...
  Scenario: Network Hrs Policy - Early-IN - MinDurReq - Case4
    ...
    And Delete Overtime Policy from TnA module
      | Name            |
      | NetWrkHrsPlcChk |
    And Delete "98" shift schedule
    And Delete "98" shift
    And Create shift in Shift Configuration
      | ShiftID | StartTime | EndTime | HalfDay | FullDay | BreakStart | BreakEnd | DeductTypeFor2+PunchFlag | DeductTypeFor2+PunchValue | Validation         |
      |      98 | 12:00     | 21:00   | 04:00   | 08:00   | 13:00      | 14:00    | True                     | Actual Break Duration     | Saved Successfully |
    And Create Shift Schedule "98" with Start Date "01/01/2010"
      | ShiftID | RepeatShiftDays |
      |      98 |               7 |
    And Configure Off Day Configuration in Shift Schedule "98"
      | OffDay1 |
      | None    |
    And Create NetWork Hours Policy "NetWrkHrsPlcChk"
      | WorkComponent | RangeFrom | RangeTo | ConsiderAs | MinDurReq | Factor | ApplicableDays |
    ...
    And Create user from user configuration
      | userid          | Active | AtdEnable | ACSEnable | ESSEnable | ESSDetail | PunchMarkingviaESS | MaxPunchesToBeConsidered | OvertimePlc     | ShiftSchedule | Validation         |
      | NetWrkHrsPlcChk | True   | True      | True      | True      | True      | True               |                        4 | NetWrkHrsPlcChk |            98 | Saved Successfully |
      | NetWrkHrsPlcChN | True   | True      | True      | True      | True      | True               | N-Punch                  | NetWrkHrsPlcChk |            98 | Saved Successfully |
    And Run Shift Process for Month = "January" and Year = "2024"
      | UserID          |
      | NetWrkHrsPlcChk |
      | NetWrkHrsPlcChN |
  ...
  Scenario: Network Hrs Policy - In-Grace
    ...
    And Create shift in Shift Configuration
      ...
      |      97 | 09:00     | 18:00   | 04:00   | 08:00   | 13:00      | 14:00    | True                     | Actual Break Duration     |                   500 | False              | Saved Successfully |
    And Create Shift Schedule "97" with Start Date "01/01/2010"
      | ShiftID | RepeatShiftDays |
      |      97 |               7 |
    And Configure Off Day Configuration in Shift Schedule "97"
      | OffDay1 |
      | None    |
    And Create NetWork Hours Policy "NetWrkHrsPlcChk"
      | WorkComponent | RangeFrom | RangeTo | ConsiderAs | MinDurReq | Factor | ApplicableDays |
    ...
    And Create user from user configuration
      | userid          | Active | AtdEnable | ACSEnable | ESSEnable | ESSDetail | PunchMarkingviaESS | MaxPunchesToBeConsidered | OvertimePlc     | ShiftSchedule | Validation         |
      | NetWrkHrsPlcChk | True   | True      | True      | True      | True      | True               |                        4 | NetWrkHrsPlcChk |            97 | Saved Successfully |
      | NetWrkHrsPlcChN | True   | True      | True      | True      | True      | True               | N-Punch                  | NetWrkHrsPlcChk |            97 | Saved Successfully |
    And Run Shift Process for Month = "January" and Year = "2024"
      | UserID          |
      | NetWrkHrsPlcChk |
      | NetWrkHrsPlcChN |
  ...
  Scenario: Network Hrs Policy - Out-Grace
    ...
    And Create shift in Shift Configuration
      ...
      | 95      | 09:00     | 18:00   | 04:00   | 08:00   | 13:00      | 14:00    | True                     | Actual Break Duration     |                     500 | False                | Saved Successfully |
    And Create Shift Schedule "95" with Start Date "01/01/2010"
      | ShiftID | RepeatShiftDays |
      | 95      |               7 |
    And Configure Off Day Configuration in Shift Schedule "95"
      | OffDay1 |
      | None    |
    ...
    And Create user from user configuration
      | userid          | Active | AtdEnable | ACSEnable | ESSEnable | ESSDetail | PunchMarkingviaESS | MaxPunchesToBeConsidered | OvertimePlc     | ShiftSchedule | Validation         |
      | NetWrkHrsPlcChk | True   | True      | True      | True      | True      | True               |                        4 | NetWrkHrsPlcChk |            95 | Saved Successfully |
      | NetWrkHrsPlcChN | True   | True      | True      | True      | True      | True               | N-Punch                  | NetWrkHrsPlcChk |            95 | Saved Successfully |
    And Run Shift Process for Month = "January" and Year = "2024"
      | UserID          |
      | NetWrkHrsPlcChk |
      | NetWrkHrsPlcChN |
  ...
  Scenario: Network Hrs Policy - In-Grace - General case1
    ...
    And Delete Overtime Policy from TnA module
      | Name            |
      | NetWrkHrsPlcChk |
    And Delete "96" shift schedule
    And Delete "96" shift
    And Create shift in Shift Configuration
      | ShiftID | StartTime | EndTime | HalfDay | FullDay | BreakStart | BreakEnd | DeductTypeFor2+PunchFlag | DeductTypeFor2+PunchValue | GrcTimeforShiftLateIN | OverlapShiftLateIn | Validation         |
      |      96 | 09:00     | 18:00   | 04:00   | 08:00   | 13:00      | 14:00    | True                     | Actual Break Duration     |                    60 | False              | Saved Successfully |
    And Create Shift Schedule "96" with Start Date "01/01/2010"
      | ShiftID | RepeatShiftDays |
      |      96 |               7 |
    And Configure Off Day Configuration in Shift Schedule "96"
      | OffDay1 |
      | None    |
    And Create NetWork Hours Policy "NetWrkHrsPlcChk"
      | WorkComponent | RangeFrom | RangeTo | ConsiderAs | MinDurReq | Factor | ApplicableDays |
    ...
    And Create user from user configuration
      | userid          | Active | AtdEnable | ACSEnable | ESSEnable | ESSDetail | PunchMarkingviaESS | MaxPunchesToBeConsidered | OvertimePlc     | ShiftSchedule | Validation         |
      | NetWrkHrsPlcChk | True   | True      | True      | True      | True      | True               |                        4 | NetWrkHrsPlcChk |            96 | Saved Successfully |
      | NetWrkHrsPlcChN | True   | True      | True      | True      | True      | True               | N-Punch                  | NetWrkHrsPlcChk |            96 | Saved Successfully |
    And Run Shift Process for Month = "January" and Year = "2024"
      | UserID          |
      | NetWrkHrsPlcChk |
      | NetWrkHrsPlcChN |
