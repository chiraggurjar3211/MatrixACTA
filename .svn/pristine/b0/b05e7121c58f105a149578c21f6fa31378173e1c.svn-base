...
public class CoffApprovalPO extends AbstractMethod {
	WebDriver driver;

	public CoffApprovalPO(WebDriver driver) {
		super(driver);
	...
	////////////////
	public void cOffApplicationApproval(String fromDtHeader, String toDtHeader, String user, String fromDate,
			String toDate, String approve, String reject, String validation) throws InterruptedException {
