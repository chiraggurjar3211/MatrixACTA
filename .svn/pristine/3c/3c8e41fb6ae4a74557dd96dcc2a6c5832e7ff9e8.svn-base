...
public class DoorUsageReportPO extends AbstractMethod {
	
	WebDriver driver;
	
	public DoorUsageReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void doorUsageReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
		pageLoadWaitng();
