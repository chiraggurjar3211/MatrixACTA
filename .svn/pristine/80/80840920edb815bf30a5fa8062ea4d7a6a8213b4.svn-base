...
public class DoorHeldOpenReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DoorHeldOpenReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void doorHeldReport(String fDate , String tDate , String reportExportFormat) throws Exception {
		pageLoadWaitng();
