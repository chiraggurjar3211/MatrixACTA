...
public class DailyWorkDetailsReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DailyWorkDetailsReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void dailyWorkDetialsReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
