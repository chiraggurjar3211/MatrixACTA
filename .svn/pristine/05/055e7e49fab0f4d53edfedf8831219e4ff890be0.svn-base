...
public class CreditDebitReportPO extends AbstractMethod {
	WebDriver driver;
	
	public CreditDebitReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void creditDebitReport(String month1 , String year1 , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
