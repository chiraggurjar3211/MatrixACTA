...
public class DoorAccessedbyUserReportPO extends AbstractMethod  {
	
	WebDriver driver;
	
	public DoorAccessedbyUserReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void doorAccessbyUserReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
		pageLoadWaitng();
