...
public class VisitorHistoryReportPO  extends AbstractMethod {
	WebDriver driver;
	
	public VisitorHistoryReportPO(WebDriver driver) {
		super(driver);
		this.driver  = driver;
	...
	public void vistorHistoryReport(String fDate , String tDate , String selectUsers , String reportExportFormat) throws Exception {
		pageLoadWaitng();
		...
		Thread.sleep(1000);
		element_DropDownSelectByvisibleText(selectUser, selectUsers);
		Thread.sleep(1000);
