...
public class UserEventIntervalReportPO extends AbstractMethod {
	WebDriver driver;
	
	public UserEventIntervalReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void userEventIntervalReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
		pageLoadWaitng();
