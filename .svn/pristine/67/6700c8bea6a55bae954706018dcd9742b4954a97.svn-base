...
public class DailySummaryReportTAPO extends AbstractMethod {
	WebDriver driver;
	
	public DailySummaryReportTAPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void dailySummaryReport(String fDate , String tDate , String format1 , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
