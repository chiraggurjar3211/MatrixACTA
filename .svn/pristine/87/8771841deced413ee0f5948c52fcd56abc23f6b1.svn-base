...
public class JobSummaryReportPO extends AbstractMethod {
	WebDriver driver;
	
	public JobSummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void jobSummaryReport(String fDate , String tDate , String selectjob , String reportExportFormat) throws Exception {
		pageLoadWaitng();
		...
		Thread.sleep(1000);
		element_DropDownSelectByvisibleText(selectJobs, selectjob);
		Thread.sleep(1000);
