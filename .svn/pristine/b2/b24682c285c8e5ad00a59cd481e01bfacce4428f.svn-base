...
public class ShiftAllowanceReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ShiftAllowanceReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void shiftAllowanceReport(String fDate, String tDate, String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
