...
public class WeekOffHolidayReportPO extends AbstractMethod {
	WebDriver driver;
	
	public WeekOffHolidayReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void weekOffHolidayReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
