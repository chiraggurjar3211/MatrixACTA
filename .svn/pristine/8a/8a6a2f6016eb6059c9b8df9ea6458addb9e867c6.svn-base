...
public class HeadCountReportPO extends AbstractMethod{
	WebDriver driver;
	
	public HeadCountReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void headCountReport(String fDate , String tDate , String reportExportFormat) throws Exception {
		pageLoadWaitng();
