...
public class WorkerAssignmentPO extends AbstractMethod{
	WebDriver driver;
	private static Logger logger=LogManager.getLogger(WorkerAssignmentPO.class);
	public WorkerAssignmentPO(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath = "//*[@class='panel-group']//*[@class='collapsed']//*[contains(text(),'Current Assignment')]")
	private List<WebElement> currentAssignmentPanelOpenOrNot;
	
	@FindBy(xpath = "//*[@class='panel-group']//*[contains(text(),'Current Assignment')]")
	private WebElement currentAssignmentsPanel;
	
	@FindBy(xpath = "//*[@class='panel-group']//*[@class='collapsed']//*[contains(text(),'Unregistered Workers')]")
	private List<WebElement> unregisteredWorkersPanelOpenOrNot;
	
	@FindBy(xpath = "//*[@class='panel-group']//*[contains(text(),'Unregistered Workers')]")
	...
	@FindBy(xpath = "//*[@id='collapseTwo']//table/tbody/tr[1]")
	private List<WebElement> unregisteredWorkerRow;
	
	//**********************************************************************************************
	//**************** Functions *******************************************************************
	//*********************************************************************************************
	public String workerAssignmentFromCWM(String workorderID, List<Map<String, String>> data) throws InterruptedException {
		pageLoadWaitng();
		String msg = null;
