...
public class TransactionWiseHoursSummaryReportPO extends AbstractMethod {
	WebDriver driver;
	
	public TransactionWiseHoursSummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void  transactionWiseHoursSummaryReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
