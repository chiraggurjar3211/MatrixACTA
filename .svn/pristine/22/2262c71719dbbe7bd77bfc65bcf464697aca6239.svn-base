...
public class AbsentAdjustmentsReportPO extends AbstractMethod {
	WebDriver driver;

	public AbsentAdjustmentsReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void absentAdjustmentsReport(String month1, String year1, String selectuser, String reportExportFormat)
			throws Exception {
		pageLoadWaitng();
