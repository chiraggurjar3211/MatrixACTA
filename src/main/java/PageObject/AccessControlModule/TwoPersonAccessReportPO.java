...
public class TwoPersonAccessReportPO extends AbstractMethod {
	WebDriver driver;
	
	public TwoPersonAccessReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void twoPersonAccessReport(String fDate , String tDate , String selectDD  , String reportExportFormat) throws Exception {
		pageLoadWaitng();
