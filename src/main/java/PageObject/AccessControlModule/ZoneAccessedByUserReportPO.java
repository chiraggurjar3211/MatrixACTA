...
public class ZoneAccessedByUserReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ZoneAccessedByUserReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void zoneAccessedByUserReport(String fDate , String tDate , String selectDD  , String reportExportFormat) throws Exception {
		pageLoadWaitng();
		...
		Thread.sleep(1000);
		element_DropDownSelectByvisibleText(selectUser, selectDD);
		Thread.sleep(1000);
