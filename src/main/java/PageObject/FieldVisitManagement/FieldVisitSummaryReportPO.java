...
public class FieldVisitSummaryReportPO extends AbstractMethod{
	
	WebDriver driver;
	
	public FieldVisitSummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void fieldVisitSummaryReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
