...
public class VisitorPunchDetialReportPO extends AbstractMethod {
	WebDriver driver;
	
	public VisitorPunchDetialReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void visitorPunchDetialReport(String fDate , String tDate , String reportExportFormat) throws Exception {
		pageLoadWaitng();
