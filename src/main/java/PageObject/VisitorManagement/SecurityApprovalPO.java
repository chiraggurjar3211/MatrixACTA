...
public class SecurityApprovalPO extends AbstractMethod{
	WebDriver driver;
	public SecurityApprovalPO(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath = "//*[@class='anchorclick']//*[contains(text(),'Pending')]")
	...
	@FindBy(xpath = "//*[@class=\"panel-heading accordion-heading\"]//label[contains(text(),\"Rejected\")]/ancestor::a[@class=\"anchorclick\"]")
	private List<WebElement> rejectedPanelOpenOrNot;

	// ************************************************************************
	// ***************FUNCTIONS********************************************
	// ************************************************************************
	public String securityApprovalFromVMS(Map<String, String> data) throws InterruptedException {
		pageLoadWaitng();
