...
public class VisitorPunchReportPO extends AbstractMethod {
	WebDriver driver;
	
	public VisitorPunchReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void visitorPunchReport(String fDate , String tDate , String selectDoor , String reportExportFormat) throws Exception {
		pageLoadWaitng();
		...
		Thread.sleep(1000);
		element_DropDownSelectByvisibleText(selectDoors, selectDoor);
		Thread.sleep(1000);
