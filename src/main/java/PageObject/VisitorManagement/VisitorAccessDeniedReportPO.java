...
public class VisitorAccessDeniedReportPO extends AbstractMethod {
	WebDriver driver;
	
	public VisitorAccessDeniedReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void visitorAccessDeniedReport(String fDate , String tDate , String selectVisitor , String reportExportFormat) throws Exception {
		pageLoadWaitng();
