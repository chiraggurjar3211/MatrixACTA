...
public class VisitorPunchExceptionReportPO extends AbstractMethod {
	WebDriver driver;
	
	public VisitorPunchExceptionReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void visitorPunchExceptionReport(String fDate , String tDate , String reportExportFormat) throws Exception {
		pageLoadWaitng();
