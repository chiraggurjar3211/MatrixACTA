...
public class DailyJobDetailsReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DailyJobDetailsReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void  dailyJobDetailsReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
