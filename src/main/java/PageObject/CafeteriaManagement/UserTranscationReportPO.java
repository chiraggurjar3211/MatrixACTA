...
public class UserTranscationReportPO extends AbstractMethod {
	WebDriver driver;
	
	public UserTranscationReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void userTransactionReport(String fDate , String tDate , String groupby , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
