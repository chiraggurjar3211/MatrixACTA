...
public class SalesReportPO extends AbstractMethod {
	WebDriver driver;
	
	public SalesReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void salesReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
