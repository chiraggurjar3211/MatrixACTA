...
public class DailyConsumptionReportPO extends AbstractMethod {
	WebDriver driver;
	
	public DailyConsumptionReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void dailyConsumptionReport(String fDate , String tDate , String groupby , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
