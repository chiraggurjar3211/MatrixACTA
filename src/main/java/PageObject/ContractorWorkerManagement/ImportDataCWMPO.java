...
public class ImportDataCWMPO extends AbstractMethod{
	WebDriver driver;
	private static Logger logger=LogManager.getLogger(ImportDataCWMPO.class);
	
	public ImportDataCWMPO(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath = "(//*[@class='table-responsive'])[1]//tbody/tr/td[2]")
	...
	// Mayank
	public void importWorkers(String fileFormat, DataTable dataTable)
		...
		if (fileFormat.equalsIgnoreCase("XLS")) {
			...
			filePath = System.getProperty("user.dir") + "\\src\\test\\resources\\ImportFile\\Workers.csv";
		}
			...
			for (Map<String, String> data : dataTable.asMaps(String.class, String.class)) {
				logger.info("ID: " + data.get("ID") + " Result: " + data.get("Result"));
				...
				for (int i = 0; i < descriptionTable.size(); i++) {
					...
					if (successCol.toUpperCase().equalsIgnoreCase(id.toUpperCase())) {
