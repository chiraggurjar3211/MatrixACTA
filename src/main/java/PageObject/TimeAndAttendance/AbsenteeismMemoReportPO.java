...
public class AbsenteeismMemoReportPO extends AbstractMethod {
	WebDriver driver;
	
	public AbsenteeismMemoReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void absenteeismMemoReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
