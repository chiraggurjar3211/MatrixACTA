...
public class EarlyOutReportPO extends AbstractMethod {
	WebDriver driver;
	
	public EarlyOutReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void earlyOutReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
