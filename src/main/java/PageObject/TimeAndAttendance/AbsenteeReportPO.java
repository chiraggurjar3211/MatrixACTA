...
public class AbsenteeReportPO extends AbstractMethod {
	WebDriver driver;
	
	public AbsenteeReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void absenteeReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
