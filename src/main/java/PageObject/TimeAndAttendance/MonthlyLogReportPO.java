...
public class MonthlyLogReportPO extends AbstractMethod {
	WebDriver driver;

	public MonthlyLogReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void monthlyLogReport(String month1, String year1, String selectuser, String reportExportFormat)
			throws Exception {
		pageLoadWaitng();
