...
public class AbsenteeDetailReportPO extends AbstractMethod {
	WebDriver driver;

	public AbsenteeDetailReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void absenteeDetialReport(String month1, String year1, String selectuser, String reportExportFormat)
			throws Exception {
		pageLoadWaitng();
