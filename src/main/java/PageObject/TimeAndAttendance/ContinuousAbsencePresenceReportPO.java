...
public class ContinuousAbsencePresenceReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ContinuousAbsencePresenceReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void continuousAbsencePresenceReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
