...
public class OvertimeChartReportPO extends AbstractMethod {
	WebDriver driver;
	
	public OvertimeChartReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 public void overtimeChartReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		 pageLoadWaitng();
