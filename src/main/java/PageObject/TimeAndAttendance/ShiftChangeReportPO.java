...
public class ShiftChangeReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ShiftChangeReportPO(WebDriver driver) {
	      super(driver);
	      this.driver = driver;
	...
	public void shiftChangeReport(String fDate, String tDate, String selectuser , String reportExportFormat) throws Exception
	{
		pageLoadWaitng();
