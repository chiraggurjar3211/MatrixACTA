...
public class UserFieldBreakReportPO extends AbstractMethod {
	WebDriver driver;

	public UserFieldBreakReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void userFieldBreakReport(String month1, String year1, String selectuser, String reportExportFormat)
			throws Exception {
		pageLoadWaitng();
