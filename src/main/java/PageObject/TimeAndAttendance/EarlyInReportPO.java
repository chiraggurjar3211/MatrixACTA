...
public class EarlyInReportPO extends AbstractMethod {
	WebDriver driver;
	
	public EarlyInReportPO(WebDriver driver) {
		super(driver);
		this.driver =driver;
	...
	public void earlyInReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
