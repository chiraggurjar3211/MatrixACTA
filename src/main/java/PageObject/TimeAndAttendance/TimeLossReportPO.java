...
public class TimeLossReportPO extends AbstractMethod {
      WebDriver driver;
      
      public TimeLossReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
    ...
    @FindBy(id = "_calFromDate")
  	...
  	public void timeLossReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
  		pageLoadWaitng();
