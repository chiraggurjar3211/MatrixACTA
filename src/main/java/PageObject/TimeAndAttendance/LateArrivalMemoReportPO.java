...
public class LateArrivalMemoReportPO extends AbstractMethod {
	WebDriver driver;
	
	public LateArrivalMemoReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void lateArrivalMemoReport(String fDate , String tDate , String selectuser , String reportExportFormat ) throws Exception {
		pageLoadWaitng();
