...
public class SalaryDataReportPO extends AbstractMethod {
	WebDriver driver;

	public SalaryDataReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void salaryDataReport(String month1, String year1, String selectuser, String reportExportFormat)
			throws Exception {
		pageLoadWaitng();
