...
public class UserIrregularityReportPO extends AbstractMethod{
	WebDriver driver;
	
	public UserIrregularityReportPO(WebDriver driver) {
		super(driver);
		this.driver  = driver;
	...
	@FindBy(id = "_calFromDate")
	 ...
	 public void userIrregularityReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		 pageLoadWaitng();
