...
public class UserAbsentReportPO extends AbstractMethod {
	WebDriver driver;
	
	public UserAbsentReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	 ...
	 public void userAbsentReport(String fDate , String tDate , String selectuser , String reportExportFormat) throws Exception {
		 pageLoadWaitng();
