...
public class PendingAuthorizationReportPO extends AbstractMethod{
	WebDriver driver;
	
	public PendingAuthorizationReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void pendingAuthorizationReport(String fDate, String tDate, String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
