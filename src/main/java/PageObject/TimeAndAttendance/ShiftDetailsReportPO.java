...
public class ShiftDetailsReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ShiftDetailsReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void shiftDetialsReport(String month1 , String year1 , String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
