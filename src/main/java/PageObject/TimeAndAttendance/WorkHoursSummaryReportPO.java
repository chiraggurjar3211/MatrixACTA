...
public class WorkHoursSummaryReportPO extends AbstractMethod {
	WebDriver driver;
	
	public WorkHoursSummaryReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void workHoursSummaryReport(String fDate , String  tDate, String selectuser , String reportExportFormat) throws Exception {
		pageLoadWaitng();
