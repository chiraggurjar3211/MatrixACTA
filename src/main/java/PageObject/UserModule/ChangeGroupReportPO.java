...
public class ChangeGroupReportPO extends AbstractMethod {
	WebDriver driver;
	
	public ChangeGroupReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void changeGroupReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
		pageLoadWaitng();
