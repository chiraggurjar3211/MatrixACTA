...
public class NewJoiningReportPO extends AbstractMethod {
	WebDriver driver;
	public NewJoiningReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void newJoiningReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
		pageLoadWaitng();
