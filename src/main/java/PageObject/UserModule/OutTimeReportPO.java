...
public class OutTimeReportPO extends AbstractMethod {
	WebDriver driver;
	
	public OutTimeReportPO(WebDriver driver) {
		super(driver);
		this.driver = driver;
	...
	public void outTimeReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
		pageLoadWaitng();
