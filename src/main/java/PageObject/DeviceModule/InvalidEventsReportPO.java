...
public class InvalidEventsReportPO extends AbstractMethod {
	WebDriver driver;
	
	public InvalidEventsReportPO(WebDriver driver) {
		super(driver);
		this.driver= driver;
	...
	public void invalidEventsReport(String fDate , String tDate , String selectDD , String reportExportFormat) throws Exception {
