...
Feature: System Account OnBehalf Applications
  ...
  @SA_OnBehalf_1
  Scenario: SA_OnBehalf - Attendance Correction - SA - Approve - User
    ...
    And Create Contractor from CWM module
      ...
      | OnBehalf1 | OnBehalf1 |              20 | OnBehalf1      |         788881 | OnBehalf1@cwm.com |      1200 | lic1        | True          | True             | Saved Successfully |
    ...
    And Create User via api
      ...
      And Create Worker via api
      | Id          | name        | Attendance-calc | ess-login | Ess-detail-edit | Attendance-via-ess | ContractorID |
      | OnBehalf_W1 | OnBehalf_W1 |               1 |         1 |               1 |                  1 | OnBehalf1    |
  ...
  @SA_OnBehalf_2
  Scenario: SA_OnBehalf - Attendance Correction - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
...
And Logout from Cosec Web
  ...
  @SA_OnBehalf_3
  Scenario: SA_OnBehalf - Attendance Correction - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
...
And Logout from Cosec Web
  ...
  @SA_OnBehalf_4
  Scenario: SA_OnBehalf - Attendance Correction - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
...
And Logout from Cosec Web
  ...
  @SA_OnBehalf_5
  Scenario: SA_OnBehalf - Advance Overtime Application - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create user from user configuration
      ...
      | OnBehalf_W1 | OnBehalf_W1 | True   | Skill-1   | OnBehalf1      | True      | True      | True               | True      | OnBehalf1   | Both              | Saved Successfully |
  ...
  @SA_OnBehalf_6
  Scenario: SA_OnBehalf - Advance Overtime Application - SA - Reject - User
   Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_7
  Scenario: SA_OnBehalf - Advance Overtime Application - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create Worker from CWM module
      ...
      | OnBehalf_W1 | OnBehalf_W1 | True   | Skill-1   | OnBehalf1      | OnBehalf_R1    | True      | True      | True               | True      | OnBehalf1   | Both              | Saved Successfully |
  ...
  @SA_OnBehalf_8
  Scenario: SA_OnBehalf - Advance Overtime Application - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_9
  Scenario: SA_OnBehalf - Leave application - Paid - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Approve Reject Leave Application from SA Date From= "0" To= "0"
      ...
      | OnBehalf_W1 | true    |        | Saved Successfully |

  @SA_OnBehalf_10
  Scenario: SA_OnBehalf - Leave application - Paid - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_11
  Scenario: SA_OnBehalf - Leave application - Paid - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_12
  Scenario: SA_OnBehalf - Leave application - Paid - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_13
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Credit_Debit_Encash Leave via API
      ...
      | OnBehalf_U1 |          0 |           0 |                 |                 |      | 140720230200 |              1 | MA         |        |       |      |          | credit | 100:00 |
      | OnBehalf_W1 |          0 |           0 |                 |                 |      | 140720230200 |              1 | MA         |        |       |      |          | credit | 100:00 |
And Apply Leave Application from leave module
      | userid      | ConsiInTermsOf | AtdDate | FromDate | ToDate | FromTime | ToTime | Leave   | Validation                   |
      | OnBehalf_U1 | Hourly         |       0 |        0 |      0 | 09:00    | 10:00  | MD - MD | No more absent records exist |
      | OnBehalf_W1 | Hourly         |       0 |        0 |      0 | 09:00    | 10:00  | MD - MD | No more absent records exist |
    And Logout from Cosec Web
    Then Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_14
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
...
And Apply Leave Application from leave module
    ...
    And Approve Reject Leave Application from SA Date From= "0" To= "0"
      ...
      | OnBehalf_W1 |     |  true      | Saved Successfully |
  @SA_OnBehalf_15
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
...
And Apply Leave Application from leave module
  ...
  @SA_OnBehalf_16
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
...
And Apply Leave Application from leave module
  ...
  @SA_OnBehalf_17
  Scenario: SA_OnBehalf - Tour application - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_18
  Scenario: SA_OnBehalf - Tour application - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_19
  Scenario: SA_OnBehalf - Tour application - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_20
  Scenario: SA_OnBehalf - Tour application - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_21
  Scenario: SA_OnBehalf - Coff application - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_22
  Scenario: SA_OnBehalf - Coff application - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_23
  Scenario: SA_OnBehalf - Coff application - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_24
  Scenario: SA_OnBehalf - Coff application - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_25
  Scenario: SA_OnBehalf - Manual Correction - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create Worker from CWM module
      ...
      | OnBehalf_W1 | OnBehalf_W1 | True   | Skill-1   | OnBehalf1      | True      | True      | True               | True      | True            | Pre-Paid    | Server Based      | None          | Saved Successfully |

    And Assign device to user via API
      | DeviceType | device      | id        |
      | ARGO FACE  | CMM_Device1 | OnBehalf_U1,OnBehalf_W1 |
  ...
  @SA_OnBehalf_26
  Scenario: SA_OnBehalf - Manual Correction - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_27
  Scenario: SA_OnBehalf - Manual Correction - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create Reporting Group
      ...
      | OnBehalf_R1      |        1 | OnBehalf_R1 |      |      |      |      | Saved Successfully |
    And Create user from user configuration
      | userid      | ReportingGroup | ESSEnable | ESSDetail | PunchMarkingviaESS | AtdEnable | CafeteriaEnable | AccountType | BalanceManagement | DiscountLevel | Validation         | AllowedUsagePerMonth |
      | OnBehalf_U1 | OnBehalf_R1    | True      | True      | True               | True      | True            | Pre-Paid    | Server Based      | None          | Saved Successfully |                      |
    And Create Worker from CWM module
      | WorkerId    | name        | Active | SkillName | ContractorName | ReportingGroup | ESSEnable | ESSDetail | PunchMarkingviaESS | AtdEnable | CafeteriaEnable | AccountType | BalanceManagement | DiscountLevel | Validation         |
      | OnBehalf_W1 | OnBehalf_W1 | True   | Skill-1   | OnBehalf1      | OnBehalf_R1    | True      | True      | True               | True      | True            | Pre-Paid    | Server Based      | None          | Saved Successfully |
    ...
    Then Login with user
      | username    | password | Validation          |
      | OnBehalf_R1 | admin    | Welcome OnBehalf_R1 |
    And Correction Approval from RIC
      | Userid      | TrnDate | UserId      | Approval | Validation         |
      | OnBehalf_U1 |       0 | OnBehalf_U1 | Approve  | Saved Successfully |
      | OnBehalf_W1 |       0 | OnBehalf_U1 | Approve  | Saved Successfully |

  @SA_OnBehalf_28
  Scenario: SA_OnBehalf - Manual Correction - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Correction Approval from RIC
      | Userid      | TrnDate | UserId      | Approval | Validation         |
      | OnBehalf_U1 |       0 | OnBehalf_U1 | Reject   | Saved Successfully |

  @SA_OnBehalf_29
  Scenario: SA_OnBehalf - Field Visit Correction - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_30
  Scenario: SA_OnBehalf - Field Visit Correction - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_31
  Scenario: SA_OnBehalf - Field Visit Correction - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_32
  Scenario: SA_OnBehalf - Field Visit Correction - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_33
  Scenario: SA_OnBehalf - Timesheet Correction - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_34
  Scenario: SA_OnBehalf - Timesheet Correction - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_35
  Scenario: SA_OnBehalf - Timesheet Correction - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_36
  Scenario: SA_OnBehalf - Timesheet Correction - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_37
  Scenario: SA_OnBehalf - Pre-Registration - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_38
  Scenario: SA_OnBehalf - Pre-Registration - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_39
  Scenario: SA_OnBehalf - Pre-Registration - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_40
  Scenario: SA_OnBehalf - Pre-Registration - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_41
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - SA - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_42
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - SA - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_43
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - RIC - Approve - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_44
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - RIC - Reject - User
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    Then Approve Reject "Short Leave/Official IN-OUT" Application from RIC Date from= "0" To= "0"
      ...
      @SA_OnBehalf_45
  Scenario: SA_OnBehalf - Attendance Correction - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_46
  Scenario: SA_OnBehalf - Attendance Correction - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_47
  Scenario: SA_OnBehalf - Attendance Correction - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_48
  Scenario: SA_OnBehalf - Attendance Correction - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_49
  Scenario: SA_OnBehalf - Advance Overtime Application - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_50
  Scenario: SA_OnBehalf - Advance Overtime Application - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_51
  Scenario: SA_OnBehalf - Advance Overtime Application - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_52
  Scenario: SA_OnBehalf - Advance Overtime Application - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_53
  Scenario: SA_OnBehalf - Leave application - Paid - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_54
  Scenario: SA_OnBehalf - Leave application - Paid - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_55
  Scenario: SA_OnBehalf - Leave application - Paid - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create Worker via api
      | Id          | name        | Attendance-calc | ess-login | Ess-detail-edit | Attendance-via-ess | ContractorID |
      | OnBehalf_R1 | OnBehalf_R1 |               1 |         1 |               1 |                  1 | OnBehalf1    |
    And Set Password via API
      | Userid      | user-verified-for-password | new-password | type |
      | OnBehalf_R1 |                          1 | admin        |    1 |
    And Create Reporting Group
  ...
  @SA_OnBehalf_56
  Scenario: SA_OnBehalf - Leave application - Paid - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_57
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_58
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_59
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_60
  Scenario: SA_OnBehalf - Leave application - Hourly Paid - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_61
  Scenario: SA_OnBehalf - Tour application - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_62
  Scenario: SA_OnBehalf - Tour application - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_63
  Scenario: SA_OnBehalf - Tour application - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_64
  Scenario: SA_OnBehalf - Tour application - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_65
  Scenario: SA_OnBehalf - Coff application - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_66
  Scenario: SA_OnBehalf - Coff application - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_67
  Scenario: SA_OnBehalf - Coff application - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_68
  Scenario: SA_OnBehalf - Coff application - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_69
  Scenario: SA_OnBehalf - Manual Correction - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_70
  Scenario: SA_OnBehalf - Manual Correction - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_71
  Scenario: SA_OnBehalf - Manual Correction - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create user from user configuration
      | userid      | ReportingGroup | ESSEnable | ESSDetail | PunchMarkingviaESS | AtdEnable | CafeteriaEnable | AccountType | BalanceManagement | DiscountLevel | Validation         | AllowedUsagePerMonth |
      | OnBehalf_W1 | OnBehalf_R1    | True      | True      | True               | True      | True            | Pre-Paid    | Server Based      | None          | Saved Successfully |                      |
    And Create Worker from CWM module
      | WorkerId    | name        | Active | SkillName | ContractorName | ReportingGroup | ESSEnable | ESSDetail | PunchMarkingviaESS | AtdEnable | CafeteriaEnable | AccountType | BalanceManagement | DiscountLevel | Validation         |
      | OnBehalf_W1 | OnBehalf_W1 | True   | Skill-1   | OnBehalf1      | OnBehalf_R1    | True      | True      | True               | True      | True            | Pre-Paid    | Server Based      | None          | Saved Successfully |
    And Assign device to user via API
    ...
    And Correction Approval from RIC
      | Userid      | TrnDate | UserId      | Approval | Validation         |
      | OnBehalf_W1 |       0 | OnBehalf_W1 | Approve  | Saved Successfully |

  @SA_OnBehalf_72
  Scenario: SA_OnBehalf - Manual Correction - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Correction Approval from RIC
      | Userid      | TrnDate | UserId      | Approval | Validation         |
      | OnBehalf_W1 |       0 | OnBehalf_W1 | Reject   | Saved Successfully |

  @SA_OnBehalf_73
  Scenario: SA_OnBehalf - Field Visit Correction - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create New System Account User
      ...
      | OnBehalf1 | OnBehalf1 | True      | Saved Successfully |
    And Create Worker via api
      | Id          | name        | Attendance-calc | ess-login | Ess-detail-edit | Attendance-via-ess | FVM-enable | ContractorID |
      | OnBehalf_W1 | OnBehalf_W1 |               1 |         1 |               1 |                  1 |          1 | OnBehalf1    |
    And Run Shift Process for Month = "0" and Year = "0"
      | UserID      |
      | OnBehalf_W1 |
    And Run Monthly Attendance Process with Close Attendance Period = "False" for Month = "0" and Year = "0"
  ...
  @SA_OnBehalf_74
  Scenario: SA_OnBehalf - Field Visit Correction - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_75
  Scenario: SA_OnBehalf - Field Visit Correction - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create Worker from CWM module
      ...
      | OnBehalf_W1 | OnBehalf_W1 | True   | Skill-1   | OnBehalf1      | OnBehalf_R1    | True      | True      | True               | True      | True      | Saved Successfully |
    And Run Shift Process for Month = "0" and Year = "0"
      | UserID      |
      | OnBehalf_W1 |
    And Run Monthly Attendance Process with Close Attendance Period = "False" for Month = "0" and Year = "0"
  ...
  @SA_OnBehalf_76
  Scenario: SA_OnBehalf - Field Visit Correction - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_77
  Scenario: SA_OnBehalf - Timesheet Correction - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Create New System Account User
      ...
      | OnBehalf1 | OnBehalf1 | True      | Saved Successfully |
    And Create Worker via api
      | Id          | name        | Attendance-calc | ess-login | Ess-detail-edit | Attendance-via-ess | job-assignment-type | ContractorID |
      | OnBehalf_W1 | OnBehalf_W1 |               1 |         1 |               1 |                  1 |                   1 | OnBehalf1    |
    And Create Job from Job Processing and Costing
      | Code      | Name      | JobStartDate | JobEndDate | EstimatedHours | Validation         |
      | OnBehalf1 | OnBehalf1 |            0 |          0 |        0002400 | Saved Successfully |
  ...
  @SA_OnBehalf_78
  Scenario: SA_OnBehalf - Timesheet Correction - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_79
  Scenario: SA_OnBehalf - Timesheet Correction - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_80
  Scenario: SA_OnBehalf - Timesheet Correction - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_81
  Scenario: SA_OnBehalf - Pre-Registration - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
    ...
    And Set Visitor Management tab parameteres in GP
      ...
      | Always                        | False                           |
    And Create Worker via api
      | Id          | name        | Attendance-calc | ess-login | Ess-detail-edit | Attendance-via-ess | authorized-host-user | ContractorID |
      | OnBehalf_W1 | OnBehalf_W1 |               1 |         1 |               1 |                  1 |                    1 | OnBehalf1    |
    And Logout from Cosec Web
    And Set User password
      | User      | NewPassword | ConfirmPassword | Validation |
    ...
    When Visitor Preregistration from VMS module
      | HostUser    | VName     | VMobile | VEmail            | VOrganization | StartDate | EndDate | StartTime | EndTime | Purpose               | VisitStation     | Validation         |
      | OnBehalf_W1 | OnBehalf1 |   45671 | OnBehalf1@vms.com | Matrix        |         0 |       0 |         2 |      62 | PreregistrationFromSA | Default Location | Saved Successfully |
    And Logout from Cosec Web
    Then Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_82
  Scenario: SA_OnBehalf - Pre-Registration - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_83
  Scenario: SA_OnBehalf - Pre-Registration - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_84
  Scenario: SA_OnBehalf - Pre-Registration - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_85
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - SA - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_86
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - SA - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_87
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - RIC - Approve - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
  ...
  @SA_OnBehalf_88
  Scenario: SA_OnBehalf - Short Leave/ Official IN-OUT Entry - RIC - Reject - Worker
    Given Open Cosec Web
    And Login with user
      | username | password | Validation           |
      | sa       | admin    | Welcome System Admin |
